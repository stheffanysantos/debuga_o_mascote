...
SLIDES = {
    ...
    "world3_0": "Como jogar: Preveja a Saída. Vamos aprender rapidinho:",
    "world3_1": "Você vai ler um trecho de código de verdade, já pronto, sem montar nada.",
    "world3_2": "Depois de ler, escolha entre as opções qual é o resultado.",
    "world3_3": "Confirme sua resposta. Aqui não existe quase certo, só certo ou errado.",
    "world4_0": "Como jogar: Complete o Código. Vamos aprender rapidinho:",
    "world4_1": "O código tem um espaço em branco no lugar de uma linha.",
    "world4_2": "Toque na linha, entre as opções, que completa certo o espaço em branco.",
    "world4_3": "Confirme sua resposta. Aqui não existe quase certo, só certo ou errado.",
    "world5_0": "Como jogar: Modo Debug. Vamos aprender rapidinho:",
    "world5_1": "Em Reordenar, toque nas linhas de código na ordem certa.",
    "world5_2": "Em Achar o Bug, toque na linha que tem o erro.",
    ...
    "recap2_0": "Mundo 2 completo! Você aprendeu Se e Enquanto, decisão e repetição condicional. Agora vem o mais parecido com programar de verdade: ler código!",
    "recap3_0": "Trilha 1 completa! Você já lê código de verdade e prevê o resultado. Agora vem a Trilha Avançada: lá você vai completar e depurar código de verdade!",
    "recap4_0": "Mundo 4 completo! Você já sabe completar código de verdade. Agora vem o Modo Debug: juntar tudo, reordenar e achar bugs em código real!",
    "recap5_0": "Você terminou os cinco mundos! Sequência, decisão, repetição, leitura, escrita e depuração de código. Você já pensa como um programador!",
}
