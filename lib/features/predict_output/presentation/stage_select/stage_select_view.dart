...
import '../gameplay/predict_output_gameplay_view.dart';
...
class PredictOutputStageSelectView extends ConsumerWidget {
  ...
  const PredictOutputStageSelectView({super.key, required this.world});
  ...
  void _openLevelAt(BuildContext context, int index) {
    Navigator.of(context).push(MaterialPageRoute(builder: (_) => PredictOutputGameplayView(levelId: _levels[index].id)));
  }
