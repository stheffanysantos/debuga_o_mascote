...
import '../gameplay/complete_code_gameplay_view.dart';
...
class CompleteCodeStageSelectView extends ConsumerWidget {
  ...
  const CompleteCodeStageSelectView({super.key, required this.world});
  ...
  void _openLevelAt(BuildContext context, int index) {
    Navigator.of(context).push(MaterialPageRoute(builder: (_) => CompleteCodeGameplayView(levelId: _levels[index].id)));
  }
