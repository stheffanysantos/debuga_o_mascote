...
void main() {
  ...
  testWidgets('vencer de verdade navega direto para a Vitória com os dados reais da partida', (tester) async {
    ...
    // visível sem precisar rolar — a tela real rola (ver GameplayScreen),
    // mas aqui simplifica o teste a interagir sem `ensureVisible` a cada toque.
    await tester.binding.setSurfaceSize(const Size(400, 1400));
    addTearDown(() => tester.binding.setSurfaceSize(null));
    Progress.instance.reset();

    await tester.pumpWidget(MaterialApp(home: GameplayScreen(level: demoLevel)));
    await tester.pump();
    ...
    // rota anterior) — escopar a busca à VictoryScreen evita colidir com
  ...
  testWidgets('bater na parede navega direto para a Falha com o motivo real', (tester) async {
    ...
    // Escopar à FailureScreen — a Gameplay continua montada por baixo.
